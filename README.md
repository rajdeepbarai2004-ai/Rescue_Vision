...
methodology is proposed that uses conventional visual data recorded by camera-equipped 
platforms to extract many rescue-critical signals. To produce a single victim priority score, the 
system combines body-part detection, monocular depth-based scene interpretation, posture 
severity estimate, and micro-motion breathing analysis.
